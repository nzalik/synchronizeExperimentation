...
DURATION_LINEAR = 30  # Durée pour la charge linéaire
DURATION = 60  # Durée totale du profil de charge (en secondes)
STEP_SIZES = [30]  # Tailles de progression à utiliser
