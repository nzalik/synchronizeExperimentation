...
class PromCrawler:
    now = None
    start = None
    prom_address = "http://127.0.0.1:30090"
    ...
    def get_promdata(self, query, traces, resourcetype, app_name):
        ...
        if pod_key_name == "" or container_key_name == "" or ns_key_name == "":
            ...
            print("AutoAssigning the container name as the app/microservice name")
            container_key_name=app_name
            print(container_key_name)
