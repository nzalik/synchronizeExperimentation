...
metric_path="../teastore_grenoble2.json"

workload_date=$(date +"%Y-%m-%d")
#workload_dir="../Load/profiles_$workload_date"
workload_dir="../Load/profiles_2024-07-31"

host="http://econome-6.nantes.grid5000.fr:30080/tools.descartes.teastore.webui"
...
export KUBECONFIG=~/admin_kube5k.conf
  ...
  env INTENSITY_FILE=$file_name locust -f /home/erods-chouette/Documents/synchronizeExperimentation/workload_generators/locust/teastore_locustfile-custom-scale.py --headless --csv-full-history --csv $log_exp_folder_path --host $host
