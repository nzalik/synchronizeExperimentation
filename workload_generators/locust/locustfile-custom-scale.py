...
####################################################################################################################################
texts = [text.replace('@', '') for text in list(open('/home/erods-chouette/PycharmProjects/synchronizeExperimentation/workload_generators/locust/datasets/fb-posts/news.txt'))]
media = [os.path.join('/home/erods-chouette/PycharmProjects/synchronizeExperimentation/workload_generators/locust/datasets/inria-person', fname) for fname in os.listdir('/home/erods-chouette/PycharmProjects/synchronizeExperimentation/workload_generators/locust/datasets/inria-person')]
users = list(range(1, 963))
cycle = 0
active_users, inactive_users = [], list(range(1, 963))
with open('/home/erods-chouette/PycharmProjects/synchronizeExperimentation/workload_generators/locust/datasets/social-graph/socfb-Reed98.mtx', 'r') as f:
    friends = {}
