...
dir="$DIR/aware-deployment-grid5k/KubePrep/kube_cluster_prep"

#git clone https://github.com/delimitrou/DeathStarBench.git
cp $dir/conf/socialnetwork/nginx-thrift-nodeport.yaml ./
cp $dir/conf/socialnetwork/media-frontend-nodeport.yaml ./
cp $dir/conf/socialnetwork/jaeger-internal.yaml ./
cp $dir/conf/socialnetwork/jaeger-external.yaml ./
cp $dir/conf/socialnetwork/jaeger-nodeport.yaml ./
