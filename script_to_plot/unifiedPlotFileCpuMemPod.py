...
def plot_json_generic(file_path, file_name, data_type='cpu'):
    ...
    if len(json_data_file1['data']['result']) > 0 and len(json_data_file2['data']['result']) > 0 and len(
       ...
       # datas4 = json_data_file4['data']['result'][0]['values']
        ...
        meanValues = np.mean([values2, values3, values1], axis=0)
...
for x in elts:
    ...
    save_path = f"/home/erods-chouette/Documents/synchronizeExperimentation/locust/synthesis2/nantes/hyperthreading/128/linear/3nodes/linear/30-10-2024/{x}/"
    ...
    save_graphics_at = f"/home/erods-chouette/Documents/synchronizeExperimentation/locust/synthesis2/nantes/hyperthreading/128/linear/3nodes/linear/30-10-2024/{x}/Plots/mean"
