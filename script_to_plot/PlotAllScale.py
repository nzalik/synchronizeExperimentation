...
for x in elts:
    ...
    plot_path = "../nantes/hyperthreading/128/group/3nodes/linear/13-08-2024/experimentation9/data/load/"
    ...
    save_path = f"../nantes/hyperthreading/128/group/3nodes/linear/13-08-2024/experimentation9/data/metrics/experimentation-output-linear_{x}requests_max_per_sec.csv/"
    #save_path = f"../nantes/hyperthreading/16-07-2024/data/metrics/experimentation-output-linear_80requests_max_per_sec.csv/"

    save_graphics_at = f"../nantes/hyperthreading/128/group/3nodes/linear/13-08-2024/experimentation9/data/Plots"
