...
latency_path = f"/home/erods-chouette/Documents/synchronizeExperimentation/locust/nantes/train/load1/nantes/hyperthreading/128/linear/3nodes/linear/11-11-2024"
...
def plot_json_generic(file_path, file_name, data_type='cpu'):
    ...
    if len(json_data_file1['data']['result']) > 0 :
        ...
        temp_list = [values1, values2, values3, values4]
...
for element in services:
    ...
    for x in elts:
        ...
        save_path = f"/home/erods-chouette/Documents/synchronizeExperimentation/locust/nantes/train/load1/nantes/hyperthreading/128/linear/3nodes/linear/11-11-2024/{x}/"
        ...
        save_graphics_at = f"/home/erods-chouette/Documents/synchronizeExperimentation/locust/nantes/train/load1/nantes/hyperthreading/128/linear/3nodes/linear/11-11-2024/{x}/Plots/merge"
       ...
       # print("all les elements")
        ...
        for idx, svc in enumerate(listElement):
            ...
            for i in range(1,4):
                plot_stats_path = f"/home/erods-chouette/Documents/synchronizeExperimentation/locust/nantes/train/load1/nantes/hyperthreading/128/linear/3nodes/linear/11-11-2024/output/{x}_{i}_stats_history.csv"
